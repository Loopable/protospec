...
| Item | Limit | Where |
| ---- | ----- | ----- |
| Username length | 1 to 32 chars | `11-accounts.md` |
...
| Social object canonical size | max 262144 bytes | `33-object-envelope.md` |
...
| Request body size | max 8 MiB | `60-federation.md` |
...
An implementation MUST reject (and MUST be tested to reject): invalid Ed25519 signatures; unauthorized devices; revoked devices producing new events; malformed event IDs; duplicate event IDs with different contents; DAG cycles; missing dependencies treated as valid; invalid AES-GCM authentication; invalid HPKE ciphertext; unauthorized recipient key use; malformed canonical encodings; unsupported mandatory versions; forged instance signatures; forged account signatures; and invalid username ownership transitions.
